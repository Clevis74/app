...
class SISMOBISecurityPerformanceTester:
    def __init__(self, base_url: str = "https://451b0d76-5395-42db-8c7e-f35063ea5702.preview.emergentagent.com"):
...
def main():
    ...
    print("Backend URL: https://451b0d76-5395-42db-8c7e-f35063ea5702.preview.emergentagent.com")
